...
if __name__ == "__main__":
    EVALUATION_SET_PATH      = "./resources/sql_evaluation_set.jsonl"
    ATTEMPTED_SOLUTIONS_PATH = "./resources/sql_attempted_solutions.jsonl"
    GRADER_RESULTS_PATH      = "./resources/sql_grader_results.jsonl"
    NUM_TEST_CASES           = 10
